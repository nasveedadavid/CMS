...
<div class="divA">
<div class="title">
<h2>READ DATA OF STAFF SALARY</h2>
</div>
<div class="divB">
<div class="divD">
<p>Click On Menu</p>
...
$query = mysqli_query($connection,"select * from ssalary");
while ($row = mysqli_fetch_array($query)) {
echo "<b><a href='view4.php?ID={$row['ID']}'>{$row['name']}</a></b>";
echo "<br />";
}
?>
</div>
...
if (isset($_GET['ID'])) {
$ID = $_GET['ID'];
$query1 = mysqli_query($connection,"select * from ssalary where ID=$ID");
...
?>
     <a href="http://localhost/cms/testsite/ins4.html">INSERT RECORDS</a><br>
<a href="http://localhost/cms/testsite/edit4.php">EDIT RECORDS</a><br> 
<a href="http://localhost/cms/testsite/del4.php">DELETE RECORDS</a>
