...
$query = mysqli_query($connection,"select * from student2");
while ($row = mysqli_fetch_array($query)) {
echo "<b><a href='view.php?ID={$row['ID']}'>{$row['name']}</a></b>";
echo "<br />";
}
?>
</div>
...
if (isset($_GET['ID'])) {
$ID = $_GET['ID'];
$query1 = mysqli_query($connection,"select * from student2 where ID=$ID");
...
?>
     <a href="http://localhost/cms/testsite/ins.html">INSERT RECORDS</a><br>
<a href="http://localhost/cms/testsite/edit.php">EDIT RECORDS</a><br> 
<a href="http://localhost/cms/testsite/del.php">DELETE RECORDS</a>
