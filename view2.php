...
if (isset($_GET['ID'])) {
$ID = $_GET['ID'];
$query1 = mysqli_query($connection,"select * from staff where ID=$ID");
...
?>
     <a href="http://localhost/cms/testsite/ins2.html">INSERT RECORDS</a><br>
<a href="http://localhost/cms/testsite/edit2.php">EDIT RECORDS</a><br> 
<a href="http://localhost/cms/testsite/del2.php">DELETE RECORDS</a>
