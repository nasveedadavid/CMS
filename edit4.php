...
<div class="divA">
<div class="title">
<h2>UPDATA DATA OF STAFF SALARY</h2>
</div>
<div class="divB">
<div class="divD">
<p>Click On Menu</p>
...
$salary= $_GET['salary'];
$query = mysqli_query($connection,"update ssalary set
name='$name', email='$email', contact='$contact',
salary='$salary' where ID='$ID'");
}
$result = mysqli_query($connection,"select * from ssalary");
while ($row = mysqli_fetch_array($result)) {
echo "<b><a href='edit4.php?update={$row['ID']}'>{$row['name']}</a></b>";
echo "<br />";
}
?>
</div><?php
...
$update = $_GET['update'];
$query1 =mysqli_query($connection,"select * from ssalary where ID=$update");
...
?>
<a href="http://localhost/cms/testsite/view4.php">VIEW RECORDS</a><br>
<a href="http://localhost/cms/testsite/del4.php">DELETE RECORDS</a><br>
<a href="http://localhost/cms/testsite/ins4.html">INSERT RECORDS</a>
</body>
</html>
