...
$update = $_GET['update'];
$query1 =mysqli_query($connection,"select * from faculty where ID=$update");
...
?>
<a href="http://localhost/cms/testsite/view1.php">VIEW RECORDS</a><br>
<a href="http://localhost/cms/testsite/del1.php">DELETE RECORDS</a><br>
<a href="http://localhost/cms/testsite/ins1.html">INSERT RECORDS</a>
</body>
</html>
