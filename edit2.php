...
$query = mysqli_query($connection,"update staff set
...
$update = $_GET['update'];
$query1 =mysqli_query($connection,"select * from staff where ID=$update");
...
?>
<a href="http://localhost/cms/testsite/view2.php">VIEW RECORDS</a><br>
<a href="http://localhost/cms/testsite/del2.php">DELETE RECORDS</a><br>
<a href="http://localhost/cms/testsite/ins2.html">INSERT RECORDS</a>
</body>
</html>
